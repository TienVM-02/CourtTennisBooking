...
namespace CourtTennisBookingV3.General
{
    public class Validate
    {
        ...
        //Validate Space
        private static Regex regexDay = new Regex("[0-9]{11}),((0|1|2)[1-9]|3[0-1]),(0[1-9]|1[1-2]),((19|20)[0-9]{2}");//lỗi
        private static Regex regexSpace = new Regex("[0-9]{11}),((0|1|2)[1-9]|3[0-1]),(0[1-9]|1[1-2]),((19|20)[0-9]{2}");//lỗi
